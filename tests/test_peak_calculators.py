...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            pyrvt.peak_calculators.BooreThompson2012("wna", 6, 20.0),
            "bt12_wna",
            "m6.00r020.0",
        ),
        (
            pyrvt.peak_calculators.BooreThompson2012("ena", 6, 20.0),
            "bt12_ena",
            "m6.00r020.0",
        ),
        (
...
def read_wang_rathje_18_data(motion_id):
    ...
    expected = {}
    for key, sheetname in [("rock", "SaRock"), ("surface", "SaSurf (Modified)")]:
        ws = wb[sheetname]
